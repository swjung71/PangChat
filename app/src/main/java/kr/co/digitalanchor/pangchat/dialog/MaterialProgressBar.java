...
/**
 * Created by Peter Jung on 2015-06-24.
 */
public class MaterialProgressBar extends ImageView {
    ...
    public void setBackgroundColor(int colorRes) {
        if (getBackground() instanceof ShapeDrawable) {
            ...
            ((ShapeDrawable) getBackground()).getPaint().setColor(ResourcesCompat.getColor(
                    getResources(), R.color.default_circle_bg_light, null));
        }
    }

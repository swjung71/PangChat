...
public class PlayRTCHandler extends PlayRTCObserver {
     ...
     */
    protected VideoChatActivity activity = null;
    ...
    public boolean isPeerSuccess = false;

    public PlayRTCHandler(VideoChatActivity activity) {
    ...
    public void createChannel(JSONObject parameters) throws RequiredConfigMissingException {
        ...
        Logger.i("Handler, createChannel : " + parameters.toString());
        playrtc.createChannel(parameters);
    }
    ...
    public void connectChannel(String channelId, JSONObject parameters) throws RequiredConfigMissingException {
        ...
        Logger.i("Handler, connectChannel channelID: " + channelId);
        Logger.i("Handler, connectChannel param : " + parameters.toString());
    ...
    public void onConnectChannel(final PlayRTC obj, final String channelId, final String reason) {
        if(reason.equals("create")) {
            this.channelId = channelId;
            this.activity.requestChat(channelId);
        }
        //this.channelId = channelId;
        isChannelConnected = true;
        Logger.i("onConnectChannel channelID : " + channelId);
    }
    ...
    public void onAddLocalStream(final PlayRTC obj, final PlayRTCMedia media) {
        ...
        Logger.i(">> 2 onLocalStream...");
        //activity.getLocalVideoView().getVideoRenderer().release();
         activity.getLocalVideoView().show(1);
    ...
    public void onDisconnectChannel(final PlayRTC obj, final String reason) {
        ...
        if(isPeerSuccess) {
            //activity.updateOnAir();
            Utils.showToast(activity, "영상채팅을 종료하였습니다.");
        }
    ...
    public void onOtherDisconnectChannel(final PlayRTC obj, final String peerId, final String peerUid) {
        ...
        if(activity.getRemoteVideoView() != null) {
            ...
            activity.getVideoArea().resizeLocalVideoView(PlayRTCVideoViewGroup.RTCViewSizeType.Full);
    ...
    */
    ...
    public void onStateChange(final PlayRTC obj, String peerId, final String peerUid, PlayRTCStatus status, String desc) {
        ...
        Logger.i(">>" + peerId + "  onStatusChange[" + status + "]..." +  "  desc[" + desc + "]..." );
        ...
        if(status == PlayRTCStatus.PeerSuccess) {
            ...
            Logger.i("PeerSuccess : ");
            if(PCApplication.getMainActivity() != null) {
                Logger.i("matching is called : " + activity.getGuestID());
                PCApplication.getMainActivity().matching(activity.getGuestID());
            }
            ...
            Utils.showToast(activity, "연결이 종료하였습니다.");
            ...
            //CameraPreview.setBlocked(true);

            Logger.i("LocalMedia");
            /*if(this.activity.getValue() == 1) {
                this.activity.createDialog();
            }*/
        }else if(status == PlayRTCStatus.Signaling){

        }else if(status == PlayRTCStatus.NetworkConnected){
            /*if(PCApplication.getMainActivity() !=  null){
                Logger.i("main release");
                PCApplication.getMainActivity().releaseCamera();
            }*/
        }
    }
